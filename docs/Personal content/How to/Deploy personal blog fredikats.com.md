FrediKats.com - это персональный блог, который собирается из [[../../Knowledge base/Tools/Markdown/Markdown|Markdown]] файлов. За основу взят шаблон [yegor256/bloghacks: Jekyll demo blog for "256 Bloghacks" book (github.com)](https://github.com/yegor256/bloghacks) от [[../../People/Yegor Bugayenko|Егора Бугаенко]].
...
- Выполнить команду `docker run -it --rm -v "${PWD}:/b" -p 4000:4000 yegor256/blog-image 'cd /b && bundle update && bundle exec jekyll serve --trace --future --host=0.0.0.0'`
	...
	- `yegor256/blog-image` - указание [[../../Knowledge base/Tools/Docker/Docker image|образа]], который будет использован для поднятия контейнера. Это специальный образ, который был собран [[../../People/Yegor Bugayenko|Егором]] для этих целей.
